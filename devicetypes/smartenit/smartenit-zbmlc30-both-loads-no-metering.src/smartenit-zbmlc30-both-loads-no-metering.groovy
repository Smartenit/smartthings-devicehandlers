 ...
 * 					 controls both loads, no metering.
 * $Rev:            $: 1
 * $Author:         $: Dhawal Doshi
 * $Date:	    $: 12/06/2016
 * $HeadURL:	    $
...
metadata {
	...
	definition (name: "Smartenit ZBMLC30 Both Loads (No Metering)", namespace: "smartenit", author: "Dhawal Doshi") {
		capability "Switch"
		...
		fingerprint profileId: "0104", inClusters: "0000,0003,0004,0005,0006", model: "ZBMLC30", deviceJoinName: "Smartenit Metering Dual Load Controller"
		fingerprint profileId: "0104", inClusters: "0000,0003,0004,0005,0006", model: "ZBMLC30-1", deviceJoinName: "Smartenit Metering Dual Load Controller"
}
...
def parse(String description) {
    ...
    {*/
        ...
        if(mapDescription.clusterInt == 6)
        {
            def attrName = null
            def attrValue = null
