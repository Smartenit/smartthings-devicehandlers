/****************************************************************************
 * DRIVER NAME:  Smartenit ZBMPlug15
 * DESCRIPTION:	 Device handler for Smartenit Metering Smartplug (#5010Q)
 * 					
 * $Rev:         $: 1
 * $Author:      $: Dhawal Doshi
 * $Date:	 $: 12/06/2016
...
metadata {
	...
	definition (name: "Smartenit ZBMPlug15", namespace: "smartenit", author: "Smartenit") {
		...
		fingerprint profileId: "0104", inClusters: "0000,0003,0004,0005,0006,0702", model: "ZBMPlug15", deviceJoinName: "Smartenit Metering Smartplug"
}
